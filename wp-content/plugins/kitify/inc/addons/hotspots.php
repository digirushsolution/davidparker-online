...
class Kitify_Hotspots extends Widget_Image {
    ...
    {
        return ['kitify-w__hotspots'];
    }

    public function get_style_depends(): array
    {
        return ['widget-image', 'kitify-w__hotspots'];
    }

    public function get_widget_css_config( $widget_name ) {

        $file_url  = kitify()->plugin_url( 'assets/css/addons/hotspots.css' );
        $file_path = kitify()->plugin_path( 'assets/css/addons/hotspots.css' );

        return [
        'key'       => $widget_name,
        'version'   => kitify()->get_version( false ),
        'file_path' => $file_path,
        'data'      => [
            'file_url' => $file_url
        ]
