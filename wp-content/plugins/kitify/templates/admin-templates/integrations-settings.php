<div class="kitify-settings-page kitify-settings-page__integratios">
  ...
  <cx-vui-input
    ...
    <cx-vui-input
      ...
      label="<?php esc_attr_e( 'Disable Google Maps API JS file', 'kitify' ); ?>"
      description="<?php esc_attr_e( 'Disable Google Maps API JS file, if it already included by another plugin or theme', 'kitify' ); ?>"
      :wrapper-css="[ 'equalwidth' ]"
      return-true="true"
      return-false="false"
