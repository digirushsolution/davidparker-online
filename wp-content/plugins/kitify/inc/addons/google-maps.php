...
class Kitify_Google_Maps extends Kitify_Base {
    ...
    protected function enqueue_addon_resources(){
	    ...
	    if(!kitify_settings()->is_combine_js_css()) {
		    $this->add_script_depends( 'kitify-w__gmap' );
	...
	public function get_widget_css_config($widget_name){
		$file_url = kitify()->plugin_url(  'assets/css/addons/google-map.css' );
		$file_path = kitify()->plugin_path( 'assets/css/addons/google-map.css' );
		return [
			'key' => $widget_name,
